...
public class SkillTreePanelUI : MonoBehaviour
{
    ...
    private string GetDetailedNodeDescription(SkillNodeSO node)
    {
        ...
        return node.nodeId switch
        {
            ...
            "dash_t2h_blind_spot" => "Isaretli hedefin yan ve arka acilarina dash ile girince kisa bir infaz zafiyeti acar. Bu node artik sadece aci alma degil, infaz node'unu besleyen setup adimidir.",
            ...
            "dash_t2h_execute" => "Dusuk canli av hedefinde ya dogrudan arka acidan ya da Blind Spot'un actigi kisa zafiyet penceresinde infaz devreye girer. Yolun asil cashout adimidir.",
